...
/**
 * An Elasticsearch Recordable implemenation that stores the 10 fields of the Log Data Model inside a JSON object,
 */
...
private:
  ...
  /**
   * Converts a common::AttributeValue into a string, which is used for converting a common::AttributeValue into a string
   */
